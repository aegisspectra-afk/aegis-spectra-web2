          ...
          <div className="container-max">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-heading font-bold mb-6">
                <span className="gradient-text">אבטחת סייבר מתקדמת</span>
              </h1>
              
              <p className="text-xl text-aegis-secondary max-w-3xl mx-auto mb-8">
                הסמכה מתקדמת באבטחת מערכות דיגיטליות - 
                ההגנה המתקדמת ביותר מפני איומי סייבר
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Button asChild variant="outline" size="lg">
                  <a href="/certificates/cyber-security.pdf" download>
                    הורד תעודה
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                ...
                >
                    ...
                    <CardContent>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <p className="text-aegis-secondary">אבטחת סייבר מתקדמת</p>
                        </div>
                        <div>
                          <h4 className="font-semibold mb-2">מנפיק התעודה</h4>
                          <p className="text-aegis-secondary">Cyber Security Institute</p>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <Badge variant="outline" className="text-xs">מתקדם</Badge>
                        </div>
                        <div>
                  ...
                  <Card className="mb-8">
                    <CardHeader>
                      <CardTitle className="text-2xl mb-4">מה זה אבטחת סייבר מתקדמת?</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-aegis-secondary mb-4">
                        הסמכה מתקדמת המתמחה בהגנה על מערכות דיגיטליות מפני איומי סייבר.
                        התעודה מוכיחה ידע מעמיק בטכנולוגיות אבטחה מתקדמות וניהול סיכונים.
                      </p>
                      <p className="text-aegis-secondary mb-4">
                        ההסמכה כוללת הכשרה מקיפה בתחומי הצפנה, ניהול זהויות, 
                        ניטור אבטחה, תגובה לאירועים וניהול סיכוני סייבר.
                      </p>
                      <p className="text-aegis-secondary">
                        מומחי הסייבר שלנו עוברים הכשרה מתמשכת ועדכונים שוטפים 
                        על האיומים החדשים ביותר בתחום אבטחת המידע.
                      </p>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-start">
                          ...
                          <div>
                            <h4 className="font-semibold mb-1">הגנה מפני איומים</h4>
                            <p className="text-sm text-aegis-secondary">הגנה מתקדמת מפני האקרים</p>
                          </div>
                        </div>
                        <div className="flex items-start">
                          <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-1 flex-shrink-0" />
                          <div>
                            <h4 className="font-semibold mb-1">ניתוח סיכונים</h4>
                            <p className="text-sm text-aegis-secondary">זיהוי וניתוח סיכוני אבטחה</p>
                          </div>
                        </div>
                        <div className="flex items-start">
                          <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-1 flex-shrink-0" />
                          <div>
                            <h4 className="font-semibold mb-1">תגובה מהירה</h4>
                            <p className="text-sm text-aegis-secondary">תגובה מהירה לאירועי אבטחה</p>
                          </div>
                        </div>
                        <div className="flex items-start">
                          <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-1 flex-shrink-0" />
                          <div>
                            <h4 className="font-semibold mb-1">מניעת פריצות</h4>
                            <p className="text-sm text-aegis-secondary">מניעה מתקדמת של פריצות</p>
                          </div>
                        </div>
                      </div>
                    </CardContent>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm">Cyber Security Institute</span>
                        </div>
                        <div className="flex items-center">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-sm">רמה: מתקדם</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="mb-6">
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        <Badge variant="outline" className="mr-2 mb-2">הצפנה</Badge>
                        <Badge variant="outline" className="mr-2 mb-2">ניהול זהויות</Badge>
                        <Badge variant="outline" className="mr-2 mb-2">ניטור אבטחה</Badge>
                        <Badge variant="outline" className="mr-2 mb-2">תגובה לאירועים</Badge>
                        <Badge variant="outline" className="mr-2 mb-2">ניהול סיכונים</Badge>
                        <Badge variant="outline" className="mr-2 mb-2">הגנה מתקדמת</Badge>
                      </div>
                    </CardContent>
                  </Card>
