...
const homeCamFormSchema = z.object({
...
type HomeCamFormData = z.infer<typeof homeCamFormSchema>;

interface HomeCamFormProps {
  onPaymentClick?: () => void;
}

export function HomeCamForm({ onPaymentClick }: HomeCamFormProps) {
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [showSuccess, setShowSuccess] = useState(false);
  const [submittedData, setSubmittedData] = useState<HomeCamFormData | null>(null);
  ...
  const {
    ...
    formState: { errors },
    reset,
  } = useForm<HomeCamFormData>({
    resolver: zodResolver(homeCamFormSchema),
  });
  ...
  const onSubmit = async (data: HomeCamFormData) => {
    ...
    try {
      ...
      trackFormSubmission('Home Cam Product Form', true);
      trackLeadGeneration('Home Cam Product Form', 1990);
      ...
      trackFormSubmission('Home Cam Product Form', false);
          ...
          >
            <Card className="w-full max-w-lg mx-4">
              <CardContent className="p-8 text-center">
                ...
                >
                  תודה {submittedData.fullName}! קיבלנו את בקשתך לחבילת Home Cam.
                </motion.p>
                ...
                >
                  <div className="flex items-center justify-center gap-2 text-blue-700 mb-2">
                    ...
                    <span className="font-semibold">חבילת Home Cam</span>
                  </div>
                  <ul className="text-sm text-blue-600 space-y-1">
                    <li>• 2 מצלמות IP 4MP</li>
                    <li>• NVR 4 ערוצים</li>
                    <li>• דיסק 1TB</li>
